...
OH_PRS = read.table("Jansen_Weights_OH_Test_No_APOE_MAF01.best", header=T)
IN_PRS = read.table("Jansen_Weights_IN_Test_No_APOE_MAF01.best", header=T)
...
Fig4=ggarrange(p4, p3) # Use 1500 x 500

tiff("Figure4.tiff", units = "in", width = 12, height = 6, res = 300)
Fig4
dev.off()
